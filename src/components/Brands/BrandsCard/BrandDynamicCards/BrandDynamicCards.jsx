  ...
  return (
    <div className="mx-auto max-w-screen-xl">
      <div className="my-5 px-6">
        ...
        <p className="leading-loose">{subdetails && subdetails ? subdetails : largefooter }</p>
      </div>
      ...
      <div className="mt-5 px-6">
        <h4 className="text-gray-800 font-bold py-5">{footerdetailshighlight}</h4>
        <p className="leading-loose">
...
<ul className="flex justify-center lg:justify-start gap-2 md:gap-3">
                ...
                <li className="bg-[#cd201f] p-2">
                  <a href="https://www.youtube.com/channel/UCFcBlDUoLaGbFQEoRvvb8zw" rel="noreferrer" target="_blank">
