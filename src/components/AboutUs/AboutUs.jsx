  ...
  return (
    <div className="mx-auto max-w-screen-xl">
      ...
      <p className=" text-gray-600 px-4">
          ...
          smoke point makes the oil a wholesome oil. <br /> <br /> Bearing that torch right up
          to this day, Bangladesh Edible Oil Limited acquired Shun Shing Edible
          Oil Limited in June 2016 to tailor to the increasing demand for edible
          oil in Bangladesh. Veola Soyabean Oil is the new addition under the
          umbrella of BEOL. <br /> <br />
        </p>
      </div>
    </div>
  );
